...
def start_simulation(uid, project_path, design_name, setup_name):
    try:
        ...
        oDesign.Save()
        print("Simulation saved for " + uid + ".")
...
csv_path = r"d:\andre\paper_sweeps\project_storage\uids.csv"  # UPDATE THIS AS NEEDED
num_sims = 3  # UPDATE THIS
design_name = "CavitySweep_hfss"  # UPDATE THIS AS NEEDED
setup_name = "Setup"  # UPDATE THIS AS NEEDED
wait_time_mins = 20  # UPDATE THIS AS NEEDED
